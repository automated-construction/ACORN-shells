...
{
    public class ACORNshellsComponent : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public ACORNshellsComponent()
          : base("ACORN-shells", "ASpi",
        ...
        {
            get { return new Guid("5ababd5a-d9e3-4eeb-8ab6-13071b299898"); }
        }
    }
}
