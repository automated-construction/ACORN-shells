...
{
    static class PsarrasBoundingBox //: GH_Component
    {

        static int m_rotations = 90; // default
        static double m_rotation_factor;
        const double TO_RADIANS = Math.PI / 180;
        //static bool RotateX = true;
        //static bool RotateY = true;
        //static bool RotateZ = true;

        /// <summary>
        /// adapted from Author: https://github.com/psarras
        /// converted to non-component class
        /// 
        ...
        */
        ...
        public static Box Solve(List<GeometryBase> geometryBases, double m_rotation_factor, bool RotateX, bool RotateY, bool RotateZ)
        {
            m_rotations = (int)(90 / m_rotation_factor);
            var plane = Plane.WorldXY; //initial plane, is an input in the original psarras script
            plane = RotateAllCombinationsOfPlane(geometryBases, plane, RotateX, RotateY, RotateZ, m_rotation_factor);
            var bb = GetBox(geometryBases, plane);
        ...
        static bool Write(GH_IWriter writer)
        {
        ...
        */
        ...
        static Plane RotateAllCombinationsOfPlane(List<GeometryBase> geo, Plane initial_plane, bool RotateX, bool RotateY, bool RotateZ, double m_rotation_factor)
        {
            ...
            if (RotateX)
            {
                rotation = GetRotationAtMinimumVolume(geo, initial_plane, rotation_axis, m_rotation_factor);
            ...
            if (RotateY)
            {
                rotation = GetRotationAtMinimumVolume(geo, plane, rotation_axis, m_rotation_factor);
                plane.Rotate(rotation, rotation_axis);
            }
            // --------------------------------------
        ...
        /// </summary>
        static double GetRotationAtMinimumVolume(List<GeometryBase> geo, Plane start_plane, Vector3d rotation_axis, double m_rotation_factor)
        {
        ...
        static double IndexOfMinimumVolume(ref double[] recorded_volumes)
        {
            var min_index = -1;
